...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { -60, 60 }   // Angles for E0, E1 (single servo) or lowered/raised (dual servo)
  #define SWITCHING_NOZZLE_E1_SERVO_ANGLES { -30, 30 }
#endif
...
#define MAX_BED_POWER 200 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 28.73 //Std 10.00 // X5SAPro 234.23
  #define DEFAULT_bedKi 5.74 //Std .023 // X5SAPro 42.97
  #define DEFAULT_bedKd 95.86 //Std 305.4 // X5SAPro 851.13
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 393 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 500, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -33, -7, -3.2 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 11  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 22  // Y point for Z homing
#endif
